        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-300 mb-4 max-w-md">
              A showcase of my work, skills, and passion for creating meaningful digital experiences through code.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://github.com/" className="text-slate-300 hover:text-white transition-colors">GitHub</a></li>
              <li><a href="https://linkedin.com/" className="text-slate-300 hover:text-white transition-colors">LinkedIn</a></li>
            </ul>
          </div>
        </div>
